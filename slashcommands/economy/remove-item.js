...
const command = {
    ...
    .addIntegerOption(o => o.setName("id-item").setDescription("ID del objeto en la tienda.").setRequired(true)),
    ...
    async run(client, interaction){
        ...
        schema.findOne({
            ...
            if(results){
                ...
                if(!Number.isInteger(interaction.options.getInteger("id-item"))) return interaction.reply({embeds: [err.setDescription("Debes poner un número positivo!")], ephemeral: true})
                if(isNaN(interaction.options.getInteger("id-item"))) {
                err.setDescription("Debes ingresar un número!")
                 return interaction.reply({embeds: [err], ephemeral: true });
                }
                let number = parseInt(interaction.options.getInteger("id-item")) - 1;
