...
const command = {
    ...
    .addIntegerOption(o => o.setName("id-item").setDescription("ID del item en la tienda").setRequired(true)),
    ...
    async run(client, interaction){
        ...
        schema.findOne({guildid: interaction.guild.id}, (err, results) => {
            ...
            let item = results.store[parseInt(numero) -1];
            let isrole = 'No';
            ...
            const embedSuccess = new MessageEmbed()
                ...
                .setColor("#00FFFF")
                .setFooter({text: "info-item Sophia Economía!", iconURL: client.user.displayAvatarURL()})
                .setTimestamp();
