	...
	data: new SlashCommandBuilder()
		...
		.addSubcommand((o) =>
			o
				...
				.addStringOption((o) =>
					o.setName('id').setDescription('Sin descripción.').setRequired(false),
				),
		)
		.addSubcommand((o) =>
			o
				...
				interaction.reply({
					embeds: [
						new MessageEmbed()
							.setTitle(':x: Error')
							.setDescription(
								'El usuario ya está en mi base de datos de eliminados permanentes.',
							)
							.setColor('RED'),
					],
					ephemeral: true,
				...
				interaction.reply({
					embeds: [
						new MessageEmbed()
							...
							.setDescription(
								`El usuario: \`${
									client.users.cache.get(opcion).tag
								}\` ha sido añadido a la eliminación de datos.`,
							)
							.setColor('GREEN'),
					],
				})
				...
				interaction.reply({
					embeds: [
						new MessageEmbed()
							.setTitle(':x: Error')
							.setDescription(
								'El usuario no está en mi base de datos de eliminados permanentes.',
							)
							.setColor('RED'),
					],
					ephemeral: true,
					...
					embeds: [
						new MessageEmbed()
							...
							.setDescription(
								`El usuario: \`${
									client.users.cache.get(opcion).tag
								}\` ha sido removido de la eliminación de datos.`,
							)
							.setColor('GREEN'),
					],
				})
