...
const command = {
    ...
    .addStringOption(o => o.setName(`pregunta`).setDescription("La opcion a votar a favor").setRequired(true)),
    ...
    async run(client, interaction){
        ...
        interaction.reply({embeds: [new MessageEmbed().setTitle(`${emojisi} Encuesta enviada`).setColor("GREEN")], ephemeral: true})
