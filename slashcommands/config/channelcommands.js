...
const command = {
    ...
    .setDescription("Establece o quita el canal de uso de comandos de Sophia del servidor.")
    ...
    async run(_, interaction){
      ...
      .setTitle('✅ Exito')
      .setColor('GREEN')
      .setDescription(`El canal de uso de comandos fue actualizado a <#${chid.id}>`);

      const success = new MessageEmbed()
      .setTitle('✅ Exito')
      .setColor('GREEN')
      .setDescription(`El canal de uso de comandos fue establecido a <#${chid.id}>`);
