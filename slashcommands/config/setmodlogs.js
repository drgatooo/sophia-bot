...
const command = {
    ...
    .addSubcommandGroup( o =>
        ...
        .addSubcommand(o =>
            o.setName("mensajes-eliminados")
            .setDescription("Si alguien elimina un mensaje, el bot lo mandará")
        )
        .addSubcommand(o =>
            o.setName("mensajes-editados")
        ...
        .addSubcommand(o =>
            o.setName("canal-editado")
            .setDescription("Revisa quien cambio el nombre a un canal o edito permisos.")
        )
        .addSubcommand(o =>
            o.setName("servidor-editado")
            .setDescription("Revisa quien cambio el nombre a un canal o edito permisos.")
        )
    )
    .addSubcommandGroup( o =>
        o.setName("desactivar")
        .setDescription("Desactiva algún log.")
        .addSubcommand(o =>
            o.setName("mensajes-eliminados")
            .setDescription("desactivar")
        )
        .addSubcommand(o =>
            o.setName("mensajes-editados")
            .setDescription("desactivar")
