...
const command = {
    ...
    .addSubcommand(o => 
        o.setName("add")
        .setDescription("Establece un rol que permitira a ciertos usuarios evador el antispam y antilinks.")
        .addRoleOption(o => 
            o.setName("rol")
            .setDescription("Rol que se evitara en los sistemas anti links y anti spam.")
            .setRequired(true)
            )
        )
    .addSubcommand(o => 
        o.setName("delete")
        .setDescription("Elimina el rol.")
    ),
    ...
    async run(client, interaction){
        ...
        if(!base){
            ...
            return interaction.reply({embeds: [
                ...
                .setDescription(`He establecido en mi base de datos el rol: ${rol} como rol para evadir mis sistemas. (anti links y spam)`)
                .setColor("GREEN")
            ]})
        } else { 
            return interaction.reply({embeds: [
                new MessageEmbed()
                .setTitle(":x: Error")
                .setDescription("Este servidor ya cuenta con un rol establecido!")
                .setColor("RED")
            ], ephemeral: true})
        }
    }
        ...
        if(subcmd === "delete"){
            if(base){
                ...
                .setTitle("✅ Hecho!")
                .setDescription("El rol de evación en este servidor ha sido eliminado.")
                .setColor("GREEN")
