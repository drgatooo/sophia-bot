		...
		.addSubcommand((o) =>
			o
				...
				.addStringOption((o) =>
					o
						.setName('duracion')
						.setDescription('Tiempo que durará el sorteo.')
						.setRequired(true),
				)
				.addIntegerOption((o) =>
					o
				...
				.addStringOption((o) =>
					o
						.setName('premio')
						.setDescription('¿Que ganara el ganador?')
						.setRequired(true),
				),
		)
		.addSubcommand((o) =>
		...
		.addSubcommand((o) =>
			o
				...
				.addStringOption((o) =>
					o
						.setName('id-sorteo')
						.setDescription('Sorteo a eliminar.')
						.setRequired(true),
				),
		)
		.addSubcommand((o) =>
			o
				...
				.addStringOption((o) =>
					o
						.setName('id-sorteo')
						.setDescription('Sorteo a terminar.')
						.setRequired(true),
				),
		)
		.addSubcommand((o) =>
			o
				...
				.addStringOption((o) =>
					o
						.setName('id-sorteo')
						.setDescription('Sorteo a pausar.')
						.setRequired(true),
				),
		)
		.addSubcommand((o) =>
			o
				...
				.addStringOption((o) =>
					o
						.setName('id-sorteo')
						.setDescription('Sorteo a reanudar.')
						.setRequired(true),
				),
		),
				...
				return interaction.reply({
					embeds: [
						new MessageEmbed()
							.setTitle(':x: Error')
							.setDescription(
								'No puedo crear un sorteo con una duración de mas de 26 dias.',
							)
							.setColor('RED'),
					],
					ephemeral: true,
				...
				return interaction.reply({
					embeds: [
						new MessageEmbed()
							.setTitle(':x: Error')
							.setDescription(
								'No puedo crear un sorteo con una duración de menos de 1 minuto.',
							)
							.setColor('RED'),
					],
					ephemeral: true,
				...
				return interaction.reply({
					embeds: [
						new MessageEmbed()
							.setTitle(':x: Error')
							.setDescription(
								'No puedo crear un sorteo con mas de 10 ganadores.',
							)
							.setColor('RED'),
					],
					ephemeral: true,
			...
			client.giveawaysManager
				.start(interaction.channel, {
					...
					messages: {
						...
						winMessage:
							'Felicidades, {winners}! has ganado **{this.prize}**!',
		...
		if (subcmd === 'reroll') {
			const giveaway = client.giveawaysManager.giveaways.find(
				(g) =>
					...
					g.messageId === interaction.options.getString('id-sorteo'),
			)
				...
				return interaction.reply({
					embeds: [
						new MessageEmbed()
							.setTitle(':x: Error')
							.setDescription(
								'No existe un sorteo con el ID: ' +
									interaction.options.getString('id-sorteo'),
							)
							.setColor('RED'),
					],
					ephemeral: true,
			...
			client.giveawaysManager
				.reroll(messageId, {
					messages: {
						congrat:
							':tada: Nuevo(s) ganador(es): {winners}! Felicidades, Has ganado **{this.prize}**!',
				...
				.then(() => {
					interaction.reply({
						embeds: [
							new MessageEmbed()
								.setColor('GREEN')
								.setDescription('Hecho! Giveaway reroll!'),
						],
					})
				})
				.catch(() => {
				...
				.then(() => {
					interaction.reply({
						embeds: [
							new MessageEmbed()
								.setColor('GREEN')
								.setDescription('Hecho! Giveaway eliminado!'),
						],
						ephemeral: true,
					})
				})
				...
				.then(() => {
					interaction.reply({
						embeds: [
							new MessageEmbed()
								.setColor('GREEN')
								.setDescription('Hecho! Giveaway finalizado!'),
						],
						ephemeral: true,
					})
				})
				...
				.then(() => {
					interaction.reply({
						embeds: [
							new MessageEmbed()
								.setColor('GREEN')
								.setDescription('Hecho! Giveaway pausado!'),
						],
						ephemeral: true,
					})
				})
				...
				.then(() => {
					interaction.reply({
						embeds: [
							new MessageEmbed()
								.setColor('GREEN')
								.setDescription('Hecho! Giveaway reanudado!'),
						],
						ephemeral: true,
					})
				})
